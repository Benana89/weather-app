...
export const WeatherCardContent = () => {
  ...
  const weatherInfoTextColor = isDarkMode
    ? "text-white"
    : "text-[#666666] opacity-80 ";
    ...
    <div>
      <div className="flex gap-3 items-end mb-2">
        <div className={textColor}>
          ...
          <span
            className={`text-7xl font-bold leading-none ${temperatureColor}`}
          >
          ...
          <span className={`font-semibold ${countryTextColor}`}>
        ...
        <div className="flex-1">
          ...
          <div
            className={`flex flex-col md:flex-row md:justify-between md:items-start items-end ${weatherInfoTextColor}`}
          >
            ...
            <div className="order-last md:order-first">
              {formatLocalTime(weatherData.timezone)}
            </div>
          </div>
        </div>
      </div>
