...
export const SearchForm = () => {
  const { cityInput, setCityInput, loading, fetchWeather, isDarkMode } =
    useWeather();
  ...
  const buttonClasses = isDarkMode ? "bg-[#28124D] " : "bg-[#6C40B5] ";

  return (
    <form
      onSubmit={handleSubmit}
      className="flex space-x-0 mb-6 w-full mx-auto gap-[10px]"
    >
